...
2 4 +
2 7 -
При таких исходных данных задачи на момент завершения эксперимента в строке 1 включен только пиксель в позиции 2, а в строке 2 – три пикселя подряд в позициях 4, 5 и 6. Самая Ответ: 2 3.
